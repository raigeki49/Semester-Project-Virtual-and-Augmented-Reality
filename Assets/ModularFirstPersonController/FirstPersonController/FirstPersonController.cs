    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            if (enableSprint && Input.GetKey(sprintKey) && sprintRemaining > 0f && !isSprintCooldown)
            {
                ...
                Vector3 clampedVelocityChange = Vector3.ClampMagnitude(velocityChange, sprintSpeed);
            ...
            else
            {
				...
				Vector3 clampedVelocityChange = Vector3.ClampMagnitude(velocityChange, walkSpeed);
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
		...
		fpc.CameraRoot = (Transform)EditorGUILayout.ObjectField(new GUIContent("CameraRoot", "Camera's root."), fpc.CameraRoot, typeof(Transform), true);
